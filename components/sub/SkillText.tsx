...
<motion.div
        ...
        >
          ...
          <h1 className="Welcome-text text-[30px] text-green-700">
            Join us to make an impact
          </h1>
        </motion.div>
        <motion.div
        variants={slideInFromLeft(0.5)}
        className='text-[30px] text-gray-700 font-medium mt-[10px] text-center mb-[15px]'
        >
            Making the world a better place
        </motion.div>
        <motion.div
        variants={slideInFromRight(0.5)}
        className='cursive text-[20px] text-gray-500 mb-10 mt-[10px] text-center'
        >
